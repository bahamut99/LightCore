...
exports.handler = async (event, context) => {
    try {
        ...
        const fuzzyMap = {
            ...
            "late afternoon": "17:00", "evening": "19:00", "dinner time": "19:00",
            "late evening": "21:00", "before bed": "22:30"
        };
        ...
        2.  **Fuzzy Time:** If no precise time is found, check for fuzzy phrases like: ${Object.keys(fuzzyMap).join(', ')}. Use its corresponding mapped time: ${JSON.stringify(fuzzyMap)}.
        3.  If an event is mentioned but has NO precise or fuzzy time, DO NOT create an event for it.

        EVENT RULES:
        - Valid event types are: 'Workout', 'Meal', 'Caffeine', 'Sleep'.
        - Do not create a 'Sleep' event for "rest", "rested", or "nap".
