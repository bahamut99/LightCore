...
function ChronoDeck() {
  ...
  function renderChronoDeckChart(ctx, data) {
    const eventConfig = {
        'Workout':  { color: 'rgba(56, 189, 248, 0.85)'}, 'Meal':     { color: 'rgba(250, 204, 21, 0.85)'},
        'Caffeine': { color: 'rgba(249, 115, 22, 0.85)'}, 'Sleep':    { color: 'rgba(167, 139, 250, 0.85)'},
  ...
  return (
    <div className="card" id="chronodeck-card">
      ...
      <div className="chart-container" style={{ height: '300px' }}>
        {isLoading ? <p className="subtle-text">Loading ChronoDeck...</p> : <canvas ref={chartRef}></canvas>}
      </div>
    </div>
  );
}
